...
<div class="container-fluid">
  ...
  <!-- Start Block For Game 1 -->
    <div class="col-sm-2 mainDiv" style="background-color:#e9b056;float:left;">
          <div class="gameDiv">
            <h1 style="text-align:center;">Game 1</h1><br />
               <h4>Result &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:RadioButton ID="RadioWin1" runat="server" GroupName="result1" Text="&nbsp;&nbsp;Win"/><br />
                  ...
                  <h4>Spectators &nbsp;&nbsp;&nbsp;
                  <asp:TextBox ID="TextBox3" runat="server" style=" width:90px;" required="required"></asp:TextBox></h4>
    ...
    <!-- Start Block For Game 2-->
     <div class="col-sm-2 mainDiv" style="background-color:#e9b056;float:left;">
          <div class="gameDiv">
            <h1 style="text-align:center;">Game 2</h1><br />
    ...
    <!-- Start Block For Game 3-->
       ...
       <div class="col-sm-2 mainDiv" style="background-color:#e9b056;float:left;">
          <div class="gameDiv">
            <h1 style="text-align:center;">Game 3</h1><br />
    ...
    <!-- Start Block For Game 4-->
      <div class="col-sm-2 mainDiv" style="background-color:#e9b056;float:left;">
          <div class="gameDiv">
            <h1 style="text-align:center;">Game 4</h1><br />
  ...
  <div style="text-align:center;">
      <asp:Button ID="Button1" runat="server" Text="Calculate Totals" 
          onclick="Button1_Click" BackColor="Blue" ForeColor="White" />
  </div>
